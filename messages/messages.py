...
messages : {
    consts.LANGUAGE_PT: {
        ...
        'ERROR_ATTEMPT_LOGIN': "FALHA ao tentar obter pedidos. Tentativa:",
        'WARN_NUVEMSHOP_LOGIN': "Logando na Nuvemshop",
        'WARN_NUVEMSHOP_GET_ORDER': "Coletando os Pedidos...",
    ...
    consts.LANGUAGE_US: {
        ...
        'ERROR_ATTEMPT_LOGIN': "FAIL to get orders. Attempt:",
        'WARN_NUVEMSHOP_LOGIN': "Logging at Nuvemshop",
        'WARN_NUVEMSHOP_GET_ORDER': "Getting orders...",
